...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Получите токен авторизации через эндпоинты <b>POST /api/v1/register</b> или <b>POST /api/v1/login</b>. Токен будет возвращен в ответе в поле <code>data.token</code>. Используйте его в заголовке <code>Authorization: Bearer {YOUR_AUTH_TOKEN}</code>.',
    ],
