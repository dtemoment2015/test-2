...
Сделать авторизацию
Создать закрытый api route для загрузки изображений(обязательно png, jpeg. Остальное ограничить)
Создать закрытый api route для получения списка загруженных тобой изображений
Создать закрытый api route для получения изображения
Создать закрытый api route для удаления изображения
Вводные данные:
Пользователь может смотреть только свои изображения
Вес файла не может быть больше 5мб
Задания со *, это будет плюсом:
Количество загружаемых файлов в день может быть более 100.000
Пространство диска не безгранично, нужно сжимать изображения без значимой потери качества(можно изменить формат изображения)
Одно и то же изображение могут загрузить очень много раз, нужно избежать дублирования.
Задание нужно будет залить в гитхаб
